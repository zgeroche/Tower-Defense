...
/*#__PURE__*/
function () {
  function HealthBar(scene, x, y, health) {
  ...
  _createClass(HealthBar, [{
    ...
    value: function draw() {
      ...
      if (this.value < 0.3 * this.maxHealth) this.bar.fillStyle(0xff0000);else if (this.value < 0.6 * this.maxHealth) {
...
function (_Phaser$GameObjects$S) {
  ...
  function Enemy(scene) {
    ...
    _this.healthbar = new HealthBar(scene, 0, 0, ENEMY_HP);
    return _this;
  }
...
function (_Phaser$GameObjects$I) {
  ...
  function Tower(scene, stats) {
    ...
    _this2 = _possibleConstructorReturn(this, _getPrototypeOf(Tower).call(this, scene)); //Phaser.GameObjects.Image.call(this, scene, 0, 0, 'goldenarmor', 'sprite25');
    ...
    _this2.str = stats.str; //value tha determines attack strength
...
function (_Phaser$GameObjects$I2) {
  ...
  function Attack(scene) {
    ...
    _this5 = _possibleConstructorReturn(this, _getPrototypeOf(Attack).call(this, scene));
    Phaser.GameObjects.Image.call(_assertThisInitialized(_assertThisInitialized(_this5)), scene, 0, 0, 'attack');
    _this5.incX = 0;
    _this5.incY = 0;
    _this5.lifespan = 0;
    _this5.speed = Phaser.Math.GetSpeed(600, 1);
    return _this5;
  }
