...
var BaseEventStream_1 = __importDefault(require("./BaseEventStream"));
...
var ReaderEventStream = (function (_super) {
    ...
    ReaderEventStream.prototype.open = function () {
        if (this.closed) {
            throw new StitchClientError_1.default(StitchClientErrorCode_1.StitchClientErrorCode.StreamClosed);
        }
        this.reset();
    };
    ...
    ReaderEventStream.prototype.readLine = function () {
        ...
        for (; this.bufferPos < this.buffer.length; this.bufferPos++) {
            ...
            if (spliceAt !== -1) {
                var line = Base64_1.utf8Slice(new Uint8Array(this.buffer.slice(0, this.bufferPos)), 0, this.bufferPos);
    ...
    ReaderEventStream.prototype.dispatchEvent = function () {
        ...
        var event = new Event_1.default(this.eventName ? this.eventName : Event_1.default.MESSAGE_EVENT, this.dataBuffer.join(''));
        this.dataBuffer = new Array();
        this.eventName = "";
        if (event.eventName === StitchEvent_1.default.ERROR_EVENT_NAME) {
